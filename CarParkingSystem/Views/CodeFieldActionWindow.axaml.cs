...
public partial class CodeFieldActionWindow : SukiWindow
{
    public CodeFieldActionWindow()
    {
        InitializeComponent();
        WeakReferenceMessenger.Default.Register<string, string>(this, TokenManage.CODE_FIELD_ACTION_WINDOW_CLOSE_TOKEN, Recieve);
    }
